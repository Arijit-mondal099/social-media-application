...
export const Privacy: React.FC = () => {
  ...
  const [accountVisibility, setAccountVisibility] = useState<string>("public");
        ...
        <CardContent>
          <form className="space-y-5 text-left">
            ...
            <div className="flex flex-col space-y-6 border p-4 rounded-md">
              ...
              <div className="space-y-4">
                <div className="space-y-4">
                  <Label htmlFor="visibility">Who can see your account?</Label>

                  <Select
                    value={accountVisibility}
                    onValueChange={(v) => setAccountVisibility(v)}
                  >
                  ...
                  <ConfirmModal
                    ...
                    description="Are you sure you want to change your account visibility?"
                    btnText="Change Visibility"
                    onConfirm={async () => {
                      // replace with your update thunk / API call
                      // await dispatch(updateVisibility({ visibility: accountVisibility }));
                      toast.success(`Visibility set to ${accountVisibility}`);
                    }}
                    trigger={
                      <Button
                        className="w-full"
